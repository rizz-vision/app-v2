...
CLOTHING_MODEL_PATH: str = os.getenv("CLOTHING_MODEL_PATH", "model/clothing_classifier_v2.keras")
CLOTHING_THRESHOLD_PATH: str = os.getenv("CLOTHING_THRESHOLD_PATH", "model/thresholds_v2.json")
